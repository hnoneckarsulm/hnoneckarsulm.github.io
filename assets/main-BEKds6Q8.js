import{r as t}from"./layout-Dp9gzVaC.js";import{o as r}from"./content-CdqfI8Gq.js";const[i,l]=r,c=e=>e.replace(/\s+/g,""),d=e=>{const s=e.replace(/^\+49/,"0").replace(/[^\d]/g,"");return s.length>5?`${s.slice(0,5)}-${s.slice(5)}`:s},a=e=>e?`
